...
def disarm_system(sender):
	...
	v['audio_test_button'].enabled = True
...
def fire_1(sender):
	sendmessage('Fire Q:1')
def fire_2(sender):
	sendmessage('Fire Q:2')
def fire_3(sender):
	sendmessage('Fire Q:3')
def fire_4(sender):
	sendmessage('Fire Q:4')
def fire_5(sender):
	sendmessage('Fire Q:5')
def fire_6(sender):
	sendmessage('Fire Q:6')
def fire_7(sender):
	sendmessage('Fire Q:7')
def fire_8(sender):
	sendmessage('Fire Q:8')
def fire_9(sender):
	sendmessage('Fire Q:9')
def fire_10(sender):
	sendmessage('Fire Q:10')
def fire_11(sender):
	sendmessage('Fire Q:11')
def fire_12(sender):
	sendmessage('Fire Q:12')
def fire_13(sender):
	sendmessage('Fire Q:13')
def fire_14(sender):
	sendmessage('Fire Q:14')
def fire_15(sender):
	sendmessage('Fire Q:15')
def fire_16(sender):
	sendmessage('Fire Q:16')
